    ...
    <>
      ...
      <div className="mb-20 w-full justify-center bottom-0 fixed">
        <div className="flex justify-center gap-2 my-2">
          <button
            onClick={() => handleKeyClick("1")}
            className="btn btn-info flex items-center justify-center w-[85px] h-[85px] active:border-none active:bg-primary active:text-white animate-none duration-75"
          >
        ...
        <div className="flex justify-center gap-2 my-2">
          ...
          <button
            onClick={() => handleDeleteClick()}
            className="btn btn-outline border-error border-4 flex items-center text-error justify-center w-[85px] h-[85px] active:bg-error active:text-white duration-75"
          >
